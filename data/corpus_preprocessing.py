...
recipe_words = recipes_df.index.values
...
co2_df.to_csv('co2\\co2_data_filtered.csv', index=False)
...
nutrient_df.to_csv('nutrition\\nutrition_data_filtered.csv', index=False)
